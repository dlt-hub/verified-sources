"""Source for Quickbooks depending on the quickbooks-python python package.
...
def quickbooks_source(
    ...
    Args:
        ...
        company_id (str): The company id provided by quickbooks. Defaults to the value in the `dlt.secrets` object.
