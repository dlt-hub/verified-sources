...
def test_all_resources(destination_name: str) -> None:
    pipeline = dlt.pipeline(pipeline_name='shopify', destination=destination_name, dataset_name='shopify_data', full_refresh=True)
...
def test_start_date() -> None:
    pipeline = dlt.pipeline(pipeline_name='shopify', destination="duckdb", dataset_name='shopify_data', full_refresh=True)
