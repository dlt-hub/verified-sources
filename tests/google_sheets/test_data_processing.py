...
TEST_CASES_URL = [
    ...
    (
        ...
        ValueError("Invalid URL. Cannot find spreadsheet ID"),
    ),
    (
    ...
    (
        "https://docs.google.com/spreadsheets/d/",
        ValueError("Spreadsheet ID is an empty string"),
    ),
]
...
row_values_1 = [
    {
        ...
        "effectiveValue": {"stringValue": "test1"},
        "formattedValue": "test1",
        "effectiveFormat": {
    ...
    {
        "userEnteredValue": {"numberValue": 1.01},
        "effectiveValue": {"numberValue": 1.01},
        "formattedValue": "1.01",
        "effectiveFormat": {
            "backgroundColor": {"red": 1, "green": 1, "blue": 1},
            "padding": {"top": 2, "right": 3, "bottom": 2, "left": 3},
    ...
    },
    {
        ...
        "effectiveValue": {"numberValue": 2.01},
        "formattedValue": "2.01",
        "effectiveFormat": {
            "backgroundColor": {"red": 1, "green": 1, "blue": 1},
            "padding": {"top": 2, "right": 3, "bottom": 2, "left": 3},
    ...
    {
        "userEnteredValue": {"numberValue": 37621},
        "effectiveValue": {"numberValue": 37621},
        "formattedValue": "12/31/2002 0:00:00",
        "userEnteredFormat": {
            "numberFormat": {
                "type": "DATE_TIME",
...
row_values_2 = [
    {
        ...
        "formattedValue": "3.00E+00",
        "userEnteredFormat": {
            "numberFormat": {"type": "SCIENTIFIC", "pattern": "0.00E+00"}
        },
        "effectiveFormat": {
            "numberFormat": {"type": "SCIENTIFIC", "pattern": "0.00E+00"},
            "backgroundColor": {"red": 1, "green": 1, "blue": 1},
    ...
    {
        "userEnteredValue": {"numberValue": 3.6},
        "effectiveValue": {"numberValue": 3.6},
        "formattedValue": "3.6",
        "effectiveFormat": {
            "backgroundColor": {"red": 1, "green": 1, "blue": 1},
            "padding": {"top": 2, "right": 3, "bottom": 2, "left": 3},
