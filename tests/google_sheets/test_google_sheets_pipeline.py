...
def test_sample_load(spreadsheet_identifier) -> None:
    ...
    data = google_spreadsheet(spreadsheet_identifier=spreadsheet_identifier, sheet_names=["sheet1"])
...
def test_appending(destination_name) -> None:
    ...
    data = google_spreadsheet(spreadsheet_identifier=TEST_SPREADSHEETS[0], sheet_names=test_ranges)
    info = pipeline.run(data)
...
def test_all_data_types(destination_name) -> None:
    ...
    data_types = google_spreadsheet(spreadsheet_identifier=TEST_SPREADSHEETS[0], sheet_names=["all_types"])
...
def test_empty_row(destination_name) -> None:
    ...
    data = google_spreadsheet(spreadsheet_identifier=TEST_SPREADSHEETS[0], sheet_names=["empty_row"])
    info = pipeline.run(data)
...
def test_empty_rows(destination_name) -> None:
    ...
    data = google_spreadsheet(spreadsheet_identifier=TEST_SPREADSHEETS[0], sheet_names=["empty_rows"])
    info = pipeline.run(data)
...
def test_has_empty(destination_name) -> None:
    ...
    data = google_spreadsheet(spreadsheet_identifier=TEST_SPREADSHEETS[0], sheet_names=["has_empty"])
    info = pipeline.run(data)
    assert_load_info(info)
...
def test_inconsistent_types(destination_name) -> None:
    ...
    data = google_spreadsheet(spreadsheet_identifier=TEST_SPREADSHEETS[0], sheet_names=["inconsistent_types"])
    info = pipeline.run(data)
...
def test_two_tables(destination_name) -> None:
    ...
    data = google_spreadsheet(spreadsheet_identifier=TEST_SPREADSHEETS[0], sheet_names=["two_tables"])
    info = pipeline.run(data)
