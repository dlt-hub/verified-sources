...
def load_pipeline_with_ranges() -> None:
    ...
    """
    pipeline = dlt.pipeline(pipeline_name="google_sheets_pipeline", destination="postgres", full_refresh=False, dataset_name="test")
...
def load_pipeline_with_sheets() -> None:
    ...
    """
    pipeline = dlt.pipeline(pipeline_name="google_sheets_pipeline", destination="postgres", full_refresh=False, dataset_name="sample_google_sheet_data")
